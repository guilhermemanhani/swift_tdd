...
class RemoteAddAccountTests: XCTestCase {
    ...
    func test_add_should_call_httpClient_with_correct_data() {
        ...
        XCTAssertEqual(httpClientSpy.data,
                       addAccountModel.toData())
    }
    ...
    func test_add_should_not_complete_if_sut_has_beem_deallocated() {
...
extension RemoteAddAccountTests{
    func makeSut(url: URL = URL(string: "http://any-url.com")!, file: StaticString = #file, line: UInt = #line) -> (sut: RemoteAddAccount, httpClientSpy: HttpPostClientSpy) {
        let httpClientSpy = HttpPostClientSpy()
